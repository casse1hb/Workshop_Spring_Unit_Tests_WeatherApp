//In this project, I have no explicitly defined
//implementation class for this interface.
//Again, that is provided by Spring Data when we boot this app.
...
//principal = principal coming from
//spring security authenticated user ID
//that's getting injected into this query.
@Repository
