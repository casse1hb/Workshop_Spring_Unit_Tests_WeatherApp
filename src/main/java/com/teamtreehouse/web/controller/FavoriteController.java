...
//Pre-authorized annotations in place of
//configuring the Spring security filter
//chain.
//pre-authorized annotation to enforce
//authorization before beginning the execution
//of the controller method.
    //And notice here I specify the authorization method I'd like to call
    //Here I want to ensure the authenticated user has the ROLE_USER role.
    ...
    //that the FavoriteService's save method is called
// passing the favorite object it received, and then a flash message is added And
//finally, Spring redirects us to the slash favorites slash,
//whatever the new favorite's ID happens to be.
//It redirects us to that URI.
